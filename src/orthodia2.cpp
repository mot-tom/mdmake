...
#include "opt.h"
using namespace std;
int UNIT_ATOM_NUM_ORTHODIA2 = 4;

extern int shape(string shape, double x, double y, double z);
 
int orthodia2(int argc, char **argv, optpara opts){
        ...
        if(opts.atomcomp == "3TO-Si") {
          atm = "Si";
          lattice_a = 5.431;
          lattice_b = 3.84030;
          lattice_c = 3.84030;
        }
        else if(opts.atomcomp == "3TO-SiGe-alloy") {
          atm = "Si";
          atm2 = "Ge";
	   ...
	   reconc2 = (double)atmnum2/atmall;
          ...
          lattice_a = lattice;
          lattice_b = 3.84030 * lattice / 5.431;
          lattice_c = 3.84030 * lattice / 5.431;
        }
        else if(opts.atomcomp == "3TO-GeSiSn-alloy") {
          atm = "Ge";
          atm2 = "Si";
          atm3 = "Sn";
          if(opts.atomratio.length() > 0) {
	   ...
	   reconc3 = (double)atmnum3/atmall;
        ...
        Coordinate atom[4] = {
                {0, 0, 0}, {0.25, 0.5, 0}, {0.5, 0.5, 0.5}, {0.75, 0, 0.5}
        };
	 ...
	 m = 0;
        for(i=0; i<nx; i++){
          for(j=0; j<ny; j++){
            for(k=0; k<nz; k++){
                for(l=0; l<UNIT_ATOM_NUM_ORTHODIA2; l++){
